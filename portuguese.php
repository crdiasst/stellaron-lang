<?php
###################################
################################### By Cris Dias (STcrisdias)
###### Navigation
$LNG['honor_good_1'] = '<font color="#3366cc">Senhor das Estrelas</font>';
$LNG['honor_good_2'] = '<font color="#0099cc">Imperador</font>';
$LNG['honor_good_3'] = '<font color="#33cccc">Imperador Master</font>';
$LNG['honor_bad_1'] = '<font color="orange">Bandido Júnior</font>';
$LNG['honor_bad_2'] = '<font color="orange">Bandido </font>';
$LNG['honor_bad_3'] = '<font color="red">Bandido Master</font>';
###### Words 
$LNG['create'] = 'Criar';
$LNG['deposit'] = 'Depositar';
$LNG['day'] = 'Dia';
$LNG['btn_vote'] = 'Votar em %s';
$LNG['btn_prosperity'] = 'Prosperidade';
$LNG['btn_synthetic'] = 'Automáticas';
###### Navigation
$LNG['nav_planet_arrowleft'] = 'Não há planetas antes';
$LNG['nav_planet_arrowright'] = 'Não há planetas depois';
$LNG['nav_resource_current'] = 'Atual';
$LNG['nav_resource911_free'] = 'Livre';
$LNG['nav_resource_production'] = 'Produção';
$LNG['nav_resource_biome'] = 'Tipo de Bonus';
$LNG['nav_resource_star'] = 'Bonus da Estrela';
$LNG['nav_terraform'] = 'Este planeta está sendo transformado';
$LNG['nav_fleet_alarm'] = 'Atividade inimiga';
$LNG['nav_fleet_noactivity'] = 'ão há movimentos de naves';
$LNG['nav_resolution_fix'] = 'Essa resolução não é recomendada se você estiver jogando em um navegador Smartphone / Tablet e algum conteúdo pode não ser exibido corretamente';
###### Error Handler
$LNG['err_resource_3'] = 'Você não tem recursos suficientes. Você precisa de mais: %s Metal, %s Cristal, %s Deutério.';
$LNG['err_resource_921'] = 'Você não tem recursos suficientes<p> Você precisa de mais: %s Matéria Negra.';
$LNG['err_no_resource_921'] = 'Não tem Matéria Negra suficiente';
$LNG['err_chat_1'] = 'Você está indo rápido demais. Jogue um pouco mais, então você poderá entrar no chat.';
###################################
###################################
###### Page: Ancient
###### Errors
$LNG['err_mothership_1'] = 'Os valores default foram ativados.';
$LNG['err_mothership_2'] = 'Você não tem recursos suficientes. Você precisa de mais: %s Metal, %s Cristal, %s Deutério.';
$LNG['err_mothership_3'] = 'Você ativou os valores Default sem nenhum módulo instalado.';
$LNG['err_mothership_4'] = 'Você não pode instalar módulos com naves em construção.';
$LNG['err_mothership_5'] = 'Você não dispõe de energia para manter este módulo. Upgrade seus Reatores ou use outro módulo que gaste menos energia.';
$LNG['err_mothership_6'] = 'Você não tem recursos suficientes para instalar este módulo.';
$LNG['err_mothership_7'] = 'O módulo foi instalado.';
$LNG['err_mothership_8'] = 'O módulo foi removido.';
$LNG['err_mothership_9'] = 'Esse módulo ancião foi criado. Por favor, atualize a página do Hangar.';
$LNG['err_mothership_10'] = 'Você já tem o seu próprio.';
$LNG['err_mothership_11'] = 'Você não possui os requisitos tecnológicos.';
$LNG['err_mothership_12'] = 'Você não pode vender um módulo que não possui.';
$LNG['err_mothership_13'] = 'O módulo foi vendido por %s unidades de Matéria Negra.';
$LNG['err_mothership_14'] = 'Os módulosnão podem ser alterados. Suas naves mães ou canhões anciãos estão sob ataque.';
$LNG['err_mothership_15'] = 'Você não selecionou o tipo de nave personalizada que deseja construir.';
###### Text
$LNG['module'] = "Módulo";
$LNG['nomodule'] = "Sem módulos instalados.";
$LNG['page_mothership_prototype'] = "Protótipo";
$LNG['page_mothership_soon'] = "Em breve";
$LNG['page_mothership_owned'] = "Adquirido";
$LNG['page_mothership_remove'] = "Removido";
$LNG['page_mothership_equipped'] = "Em uso";
$LNG['page_mothership_install'] = "Instalar";
$LNG['page_mothership_scrap'] = "Reciclar";
$LNG['page_mothership_scrap_title'] = "Reciclar em troca de recursos";
$LNG['page_mothership_find_module_tech'] = "Encontrar esse módulo em expedições requer Tecnologia Anciã %s ou superior";
$LNG['page_mothership_find_module_event'] = "Esse módulo somente pode ser adquirido por meio de eventos";
$LNG['page_mothership_miss_tech'] = "Sem tecnologia";
$LNG['page_mothership_module_costAfter'] = "Adicionar à nave";
$LNG['page_mothership_module_costInstall'] = "Custo para instalar";
$LNG['page_mothership_module_weapons'] = "Armas";
$LNG['page_mothership_module_weapons_desc'] = "Esse módulo apresenta o tipo de arma que sua nave usa";
$LNG['page_mothership_module_reactor'] = "Reator";
$LNG['page_mothership_module_reactor_desc'] = "Cada módulo de sua Nave Mãe gasta energia e você precisará de um reator para suportar a demanda de energia.";
$LNG['page_mothership_module_engine'] = "Motor";
$LNG['page_mothership_module_engine_desc'] = "Esse módulo modifica o tipo do motor que você usa, a velocidade de sua nave e seu consumo.";
$LNG['page_mothership_module_armor'] = "Blindagem";
$LNG['page_mothership_module_armor_desc'] = "Este módulo fornece a fuselagem  e define a capacidade da sua Nave Mãe.";
$LNG['page_mothership_module_shield'] = "Escudo";
$LNG['page_mothership_module_shield_desc'] = "Este módulo é necessário para proteger a fuselagem.";
$LNG['page_mothership_module_auxiliary'] = "Auxiliar";
$LNG['page_mothership_module_auxiliary_desc'] = "Este módulo permite que você desbloqueie bônus com sua Nave Mãe, tais como novas missões.";
$LNG['page_mothership_module_ancienttech'] = "Esta página mostra que módulos você pode encontrar através da missão Expedição. A fim de aumentar a variedade de módulos, você deve aumentar o nível sa sua Tecnologia Anciã";
$LNG['page_mothership_module_expedition'] = "Para poder usar esse módulo, você deve primeiro encontrá-lo na missão Expedição";
$LNG['page_mothership_module_notech'] = "Você não tem tecnologia suficiente para ganhar este módulo";
$LNG['page_mothership_module_equipped'] = "Este módulo está atualmente em uso em sua Nave Mãe";
###### Modules   -  parando aqui por hora... Continuo amanhã - STcrisdias
$LNG['engine'] = "Engine";
$LNG['shield'] = "Shield";
$LNG['armor'] = "Armor";
$LNG['reactor'] = "Reactor";
...
$LNG['page_darkmatter_rule_1'] = 'You can get Dark Matter through Expedition,
 selling Ancient defenses and Mothership Modules or voting for Stellaron.';
...
$LNG['star_type_K_desc'] = "These main-sequence stars, sometimes referred to as orange dwarves, are a fairly common sight. They are stable on the main-sequence for up to 30 billion years, meaning that
 worlds orbiting a K-type star have a longer than average window to evolve life.";
...
$LNG['mission_daily_5_desc']
 = "Acquire additional 5 levels on random Officier";
...
$LNG['mission_ancient_2_0'] = "<table><tr><td>After you acquire the first level of Ancient Technology,
 you can level up it on Research Page. Higher the Ancient Tech, better modules you can find for your both ship and defense</td></tr></table>";
/**/
...
$LNG['page_synthetics_config_report']
 = 'Do not receive battle reports from this planet';
...
$LNG['type_planet_tropical_desc']					= "Humid, rocky world with a thick nitrogen-oxygen atmosphere. Seasons
 with significant precipitation are interchanged with drier periods. Most landmasses are covered in dense vegetation.";
###################################
###################################
###### Page: Vote
# Buttons
...
$LNG['longDescription'][299]
 = "The Space Dragon is the leviathan. It can move extremely fast within a star system and its name is Avice, and is presumably either female or likewise as defeating it gives you an egg that turns into your ship.";
